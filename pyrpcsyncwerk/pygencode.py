...
static PyMethodDef RpcsyncwerkClientModule_Functions[] = {
    ${array}
    {NULL, NULL, 0, NULL},
};
"""
...
def gen_fcall_funcs_array(arg_types):
    ...
    if len(arg_types) == 0:
        ...
        cfuncname = "RpcsyncwerkClient_Fcall__Void"
    else:
        ...
        cfuncname = "RpcsyncwerkClient_Fcall__" + "_".join(tmplist)
...
def gen_fret_funcs_array(ret_type):
    ...
    if ret_type is None:
        ...
        cfuncname = "RpcsyncwerkClient_Fret__Void"
    else:
        pyfuncname = "fret__" + ret_type
        cfuncname = "RpcsyncwerkClient_Fret__" + string.capitalize(ret_type)
...
def gen_module_funcs_array():
    """
    Generate static PyMethodDef RpcsyncwerkClientModule_Functions[]
    """
...
fcall_template = r"""
static PyObject *
RpcsyncwerkClient_Fcall__${Suffix}(PyObject *self,
                              PyObject *args)
{
    char *fname;
${def_args}
    ...
    fcall = rpcsyncwerk_client_fcall__${suffix}(${args});
